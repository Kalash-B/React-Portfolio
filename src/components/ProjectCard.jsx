...
const ProjectCard = ({ title, desc, img, tech, link }) => {
  ...
  return (
    <div className="group [perspective:1000px] h-80">
        ...
        {/* Back Side */}
        <div className="absolute inset-0 w-full h-full group-hover:[transform:rotateY(180deg)] [backface-visibility:hidden] [transform:rotateY(180deg)] bg-gradient-to-br from-[#1e293b] to-[#334155] rounded-2xl shadow-lg flex flex-col items-center justify-center p-6">
